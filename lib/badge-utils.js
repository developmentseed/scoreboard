export const badgeMetrics = [
  ...
  { label: 'Coastlines added', value: 'coastlines_added' },
  { label: 'Coastlines modified', value: 'coastlines_modified' },
  { label: 'Coastlines added (km)', value: 'coastlineKm' },
  { label: 'Coastlines modified (km)', value: 'coastlineKmMods' },
