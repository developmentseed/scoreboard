...
function updateCampaigns (store, storeData) {
  ...
  let { searchText: q, page, compl_min, compl_max, valid_min, valid_max } = storeData

  fetch(createApiUrl('/api/campaigns', { q, page, compl_min, compl_max, valid_min, valid_max }))
    .then(async res => {
