...
function updateCampaigns (store, storeData) {
  ...
  let { searchText: q, page, compl_min, compl_max, valid_min, valid_max, selectedTM: tm } = storeData

  fetch(createApiUrl('/api/campaigns', { q, page, tm, compl_min, compl_max, valid_min, valid_max }))
    .then(async res => {
